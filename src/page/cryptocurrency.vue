    ...
    <div>
        ...
        <el-row style="margin-top: 20px;">
		      ...
		      <router-link :to="'/city/' + guessCityid" class="guess_city">
                <img src="@/assets/img/Bitcoin.png" style="width: 280px;margin: 80px">
  		 ...
  		 <el-row style="margin-top: 20px;">
  			<el-col :span="12" :offset="4">
		      <router-link :to="'/city/' + guessCityid" class="guess_city">
                <img src="@/assets/img/Ethereum.png" style="height: 140px;margin: 80px">
                <svg class="arrow_right">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                </svg>
            </router-link>
  		 ...
  		 <el-row style="margin-top: 20px;">
  			<el-col :span="12" :offset="4">
		      <router-link :to="'/city/' + guessCityid" class="guess_city">
                <img src="@/assets/img/Dash.png" style="height: 120px;margin: 80px">
                <svg class="arrow_right">
                    <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                </svg>
            </router-link>
