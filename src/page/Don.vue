    ...
    <div>
     	<head-top></head-top>
	  			...
	  			<el-form :model="foodForm" :rules="foodrules" ref="foodForm" label-width="110px" class="form food_form">
					...
					<el-form-item>
						<el-button type="primary" @click="addFood('foodForm')">确认捐助</el-button>
					</el-form-item>
	  			</el-form>
