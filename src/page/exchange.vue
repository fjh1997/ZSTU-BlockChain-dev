<template>
    <div>
     	<head-top></head-top>
	  			...
	  			<header class="form_header">兑换Token</header>
	  			<el-form :model="foodForm" :rules="foodrules" ref="foodForm" label-width="110px" class="form food_form">
					...
					<el-form-item label="开户人" prop="activity">
					...
					<el-form-item>
						<el-button type="primary" @click="addFood('foodForm')">确认兑换Token</el-button>
					</el-form-item>
	  			</el-form>
